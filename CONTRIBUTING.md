Contributing to Elecash Core
============================

The Elecash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Elecash Core project, and is not to be
confused with overall Elecash Network Protocol consensus changes.

Whether a pull request is merged into Elecash Core rests with the project merge
...
Patches that change Elecash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Elecash consensus, it must have been
...
The project leader is the release manager for each Elecash Core release.
