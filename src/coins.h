...
/** 
    ...
    ****Note - for Elecash we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of elecash coming in to a transaction
