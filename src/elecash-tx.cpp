...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Elecash Core elecash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  elecash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded elecash transaction") + "\n" +
                               "  elecash-tx [options] -create [commands]   " + _("Create hex-encoded elecash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded elecash transaction
