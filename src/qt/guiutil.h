...
/** Utility functions used by the Elecash Qt UI.
 */
namespace GUIUtil
{
...
// Render Elecash addresses in monospace font
...
// Parse "elecash:" URI into recipient object, return true on successful parsing
