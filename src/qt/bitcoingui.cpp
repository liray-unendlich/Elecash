                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Elecash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Elecash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and elecash: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zELC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Elecash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Elecash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Elecash"));
    ...
    changePasselcaseAction = new QAction(QIcon(":/icons/key"), tr("&Change Passelcase..."), this);
    changePasselcaseAction->setStatusTip(tr("Change the passelcase used for wallet encryption"));
    unlockWalletAction = new QAction(tr("&Unlock Wallet..."), this);
    unlockWalletAction->setToolTip(tr("Unlock wallet"));
    lockWalletAction = new QAction(tr("&Lock Wallet"), this);
    signMessageAction = new QAction(QIcon(":/icons/edit"), tr("Sign &message..."), this);
    signMessageAction->setStatusTip(tr("Sign messages with your Elecash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Elecash addresses"));
    bip38ToolAction = new QAction(QIcon(":/icons/key"), tr("&BIP38 tool"), this);
    bip38ToolAction->setToolTip(tr("Encrypt and decrypt private keys using a passelcase"));
    ...
    openAction->setStatusTip(tr("Open a Elecash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Elecash Core help message to get a list with possible Elecash command-line options"));
    ...
    if (walletFrame) {
        ...
        connect(changePasselcaseAction, SIGNAL(triggered()), walletFrame, SLOT(changePasselcase()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        settings->addAction(changePasselcaseAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    changePasselcaseAction->setEnabled(enabled);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Elecash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Elecash network", "", count));
}
...
{
    QString strTitle = tr("Elecash Core"); // default title
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        changePasselcaseAction->setEnabled(false);
    ...
    case WalletModel::Unlocked:
        ...
        changePasselcaseAction->setEnabled(true);
        unlockWalletAction->setVisible(false);
