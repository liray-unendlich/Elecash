                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzelcPathCustom = GetArg("-zelcbackuppath", "");
    ...
    if(!strzelcPathCustom.empty()) {
        ui->wallet_customzelcbackuppath->setText(QString::fromStdString(strzelcPathCustom));
        ui->wallet_customzelcbackuppath_label->setVisible(true);
        ui->wallet_customzelcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzelcPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Elecash RPC console.") + "<br>" +
