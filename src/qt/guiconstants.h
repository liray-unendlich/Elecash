...
/* AskPasselcaseDialog -- Maximum passelcase length */
static const int MAX_PASSELCASE_SIZE = 1024;

/* Elecash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Elecash"
#define QAPP_ORG_DOMAIN "elecash.org"
#define QAPP_APP_NAME_DEFAULT "Elecash-Qt"
#define QAPP_APP_NAME_TESTNET "Elecash-Qt-testnet"
