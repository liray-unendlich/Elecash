...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemaelecashGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemaelecashGrant grantOutbound;
