...
#   c) node1 mines 32 blocks, so now node 0 has 60001elc, node 1 has 4250elc, node2 has none.
#   d) node0 sends 601 elc to node2, in two transactions (301 elc, then 300 elc).
