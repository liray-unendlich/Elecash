...
This means one can have an always-on elecashd instance running, and another local elecashd/elecash-qt instance which connects to this node and receives blocks from it.
