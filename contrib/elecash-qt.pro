...
FORMS += src/qt/forms/addressbookpage.ui \
         src/qt/forms/askpasselcasedialog.ui \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/qt/askpasselcasedialog.cpp \
...
RESOURCES += src/qt/elecash.qrc src/qt/elecash_locale.qrc

TRANSLATIONS += src/qt/locale/elecash_bg.ts \
                src/qt/locale/elecash_de.ts \
                src/qt/locale/elecash_en.ts \
                src/qt/locale/elecash_es.ts \
                src/qt/locale/elecash_fi.ts \
                src/qt/locale/elecash_fr.ts \
                src/qt/locale/elecash_it.ts \
                src/qt/locale/elecash_ja.ts \
                src/qt/locale/elecash_pl.ts \
                src/qt/locale/elecash_pt.ts \
                src/qt/locale/elecash_ru.ts \
                src/qt/locale/elecash_sk.ts \
                src/qt/locale/elecash_sv.ts \
                src/qt/locale/elecash_vi.ts \
                src/qt/locale/elecash_zh_CN.ts \
                src/qt/locale/elecash_zh_TW.ts
