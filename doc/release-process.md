...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/elecashproject/Elecash/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/elecashproject/gitian.sigs.git
...
### Build and sign Elecash Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit elecash=v${VERSION} ../elecash/contrib/gitian-descriptors/gitian-win.yml
...
- Detached signatures will then be committed to the [elecash-detached-sigs](https://github.com/elecashproject/elecash-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/elecashproject/Elecash/releases/new) with a link to the archived release notes.
