...
In order to support loading of multiple wallets in elecash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is elecash.cpp.
...
Changes to elecash.cpp
----------------------
elecash.cpp is the entry point into elecash-qt, and as such, will require some minor modifications to provide hooks for
