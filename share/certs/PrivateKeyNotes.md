...
The key and certificate is in a separate, passelcase-protected keychain file that is
...
The key and certificate were exported into a separate, passelcase-protected PKCS#12 file, and
...
install a keylogger to get the passelcase that protects them.
